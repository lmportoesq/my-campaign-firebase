...
function Login() {
    ...
    return (
        <div className='container mx-auto my-auto w-[30rem] h-[30rem] mt-20'>
            <form className='shadow-lg shadow-blue-900 border-red-300 h-[20rem] mx-auto my-auto grid grid-col-1 gap-3 text-center p-5 rounded-lg'>
